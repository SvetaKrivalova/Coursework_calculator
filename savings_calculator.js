...
if ( $("#savings-chart").length ) {
  ...
  */
  ...
  document.addEventListener("DOMContentLoaded", function(){
     ...
     if (n == 12) {
      $("#savings-results").append("После " + t + " лет сбережений при годовой процентной ставке " + r_percentage + "% и ежемесячных взносах в размере " + PMT + " рублей, вы накопите " + "<strong style='color: green'>" + last_year_sum_interest + "</strong> рублей" + ". Без каких-либо процентов вы бы накопили всего " + "<strong style='color:red'>" + last_year_sum_no_interest+ "</strong> рублей" + ".");
     //Message for yearly contributions
     } else if (n = 1) {
       $("#savings-results").append("После " + t + " лет сбережений при годовой процентной ставке " + r_percentage + "% и ежегодных взносах в размере " + PMT + " рублей, вы накопите " + "<strong style='color: green'>" + last_year_sum_interest + "</strong> рублей" + ". Без каких-либо процентов вы бы накопили всего " + "<strong style='color:red'>" + last_year_sum_no_interest+ "</strong> рублей" + ".");
